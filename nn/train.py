...
from nn.dataset import granularity
...
def train():
    ...
    parser.add_argument("--datadir", help="input data dir generated by data/split.py (contains e.g. train.json and train/", required=True)
    ...
    model = NutritionalDenseNet() # ResNet50()#


    net = model.get_model_on_device()
    device = model.ged_device()

    train_dataset = ImageDataset(datadir / "train.json", datadir / "train")
    val_dataset = ImageDataset(datadir / "val.json", datadir / "val")
